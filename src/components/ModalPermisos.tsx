...
export const ModalPermisos = (props:PropsModalPermisos) => {
    return (
    <Modal
        animationType="fade"
        transparent={true}
        ...
        <View style={styles.centeredView}>
            <View style={styles.modalView}>
                <View style={styles.headerImageContainer}>
                    <Image style={styles.headerImage} source={require('../images/permisoIcon.png')}/>
                </View>
                ...
                <View style={styles.buttonsModalContainer}>
                    <TouchableOpacity onPress={()=>props.closeModal()} activeOpacity={0.7} style={{...styles.buttonModal, backgroundColor:'#A0001A'}}>
                        <Text style={{...styles.textButtonModal, color:'white'}}>No Permitir</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={()=>props.closeModal()} activeOpacity={0.7} style={{...styles.buttonModal, backgroundColor:'#A6D8F6'}}>
                        <Text style={{...styles.textButtonModal, color:'black'}}>Permitir</Text>
                    </TouchableOpacity>
                </View>
